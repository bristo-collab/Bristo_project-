...
const SearchResults = () => {
    ...
    useEffect(() => {
        ...
        let results = allProducts.filter(product => {
            ...
            return matchesQuery && matchesCategory && matchesBrand && matchesPrice && isActive;
        });
    ...
    }, [query, selectedCategories, selectedBrands, priceRange, sortBy, allProducts, loading]);
                ...
                <main className="search-results">
                    ...
                    {loading ? (
                        ...
                        <div className="products-grid">
                            {filteredProducts.map((product) => (
                                <div key={product._id} className="product-card">
                                    ...
                                    {product.tags?.length > 0 && <span className="product-tag">{product.tags[0]}</span>}
                                    ...
                                    <div className="product-details">
                                        <div className="product-meta">
                                            <div className="product-rating">
                                                <span className="star">★</span> {product.rating || 0} <span className="reviews">({product.reviews || 0})</span>
                                            </div>
                                        </div>
                        ...
                        <div className="no-results-found">
                            ...
                            <p>Try searching for a different item or browse our categories.</p>
                        </div>
                    )}
                </main>
            </div>
